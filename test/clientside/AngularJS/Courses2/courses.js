...
/*       $scope.courses = [
	  ...
	  $scope.courses = [
		{title: "Steel Leaf Rake", start: new Date(2015,1,1), price: 14.97, category: "Rakes"},
		{title: "Post Hole Digger", start: new Date(2015,2,2), price: 34.97, category: "Digging Tools"}
	  ];
